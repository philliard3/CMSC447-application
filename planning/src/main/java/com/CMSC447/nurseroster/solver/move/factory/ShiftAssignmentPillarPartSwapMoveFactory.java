...
import com.CMSC447.nurseroster.solver.move.EmployeeMultipleChangeMove;
...
public class ShiftAssignmentPillarPartSwapMoveFactory implements MoveListFactory<NurseRoster> {
    ...
    @Override
    public ArrayList<Move<NurseRoster>> createMoveList(NurseRoster nurseRoster) {
    	return new ArrayList<Move<NurseRoster>>();
    	/*
